...
PG_KEYWORD("allshortestpaths", ALLSHORTESTPATHS, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("assert", ASSERT, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("contains", CONTAINS, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("dijkstra", DIJKSTRA, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("ends", ENDS, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("merge", MERGE, RESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("optional", OPTIONAL_P, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("property", PROPERTY, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("remove", REMOVE, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("shortestpath", SHORTESTPATH, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("single", SINGLE, UNRESERVED_KEYWORD, AS_LABEL)
PG_KEYWORD("size", SIZE_P, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("starts", STARTS, UNRESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("unwind", UNWIND, RESERVED_KEYWORD, AS_LABEL)
