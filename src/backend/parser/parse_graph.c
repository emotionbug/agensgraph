...
static void transformVertexId(Node **vid_expr,
							  ParseNamespaceItem **vertex_nsitem,
							  ParseState *pstate, CypherRel *crel,
		...
		foreach(lp, c)
		{
			...
			for (;;)
			{
				...
				if (prev_crel == NULL)
				{
					...
					transformVertexId(&vid_expr, &vertex_nsitem, pstate, crel, vertex,
...
static void
transformVertexId(Node **vid_expr, ParseNamespaceItem **vertex_nsitem,
				  ParseState *pstate, CypherRel *crel, Node *vertex,
